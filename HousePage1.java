...
public class HousePage1 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage1(String loggedInUsername){
		...
		File file = new File("House/houseno404.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage1(loggedInUsername);
