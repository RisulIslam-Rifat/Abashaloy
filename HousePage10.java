...
public class HousePage10 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage10(String loggedInUsername){
		...
		File file = new File("House/houseno590.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage10(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage10(loggedInUsername);
