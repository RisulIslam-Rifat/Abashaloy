...
public class HousePage4 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage4(String loggedInUsername){
		...
		File file = new File("House/houseno104.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage4(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage4(loggedInUsername);
