...
public class HousePage11 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage11(String loggedInUsername){
		...
		File file = new File("House/houseno607.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage11(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage11(loggedInUsername);
