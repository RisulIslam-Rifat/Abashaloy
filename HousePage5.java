...
public class HousePage5 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage5(String loggedInUsername){
		...
		File file = new File("House/houseno201.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage5(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage5(loggedInUsername);
