...
public class HousePage2 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage2( String loggedInUsername){
		...
		File file = new File("House/houseno405.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage2(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage2(loggedInUsername);
