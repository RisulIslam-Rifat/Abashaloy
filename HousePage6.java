...
public class HousePage6 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage6( String loggedInUsername){
		...
		File file = new File("House/houseno109.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage6(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage6(loggedInUsername);
