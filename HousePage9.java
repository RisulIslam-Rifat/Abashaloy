...
public class HousePage9 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage9(String loggedInUsername){
		...
		File file = new File("House/houseno790.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage9(loggedInUsername);
		}
