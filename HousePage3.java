...
public class HousePage3 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage3(String loggedInUsername){
		...
		File file = new File("House/houseno406.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage3(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage3(loggedInUsername);
