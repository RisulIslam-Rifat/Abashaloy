...
public class HousePage8 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage8(String loggedInUsername){
		...
		File file = new File("House/houseno044.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage8(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage8(loggedInUsername);
