...
public class HousePage7 extends JFrame implements MouseListener  {
	
	JLabel imageLabel1,Housenumber;
	JButton backButton,reviewButton;
	JTextArea Housedetails;
	static  String loggedInUsername;
	public HousePage7(String loggedInUsername){
		...
		File file = new File("House/houseno304.txt");
	...
	public void mouseClicked(MouseEvent e) {
        if (e.getSource() == backButton) {
			...
			dispose();
			new ReviewPage7(loggedInUsername);
		}
	...
	public static void main ( String args[]){
		...
		new HousePage7(loggedInUsername);
